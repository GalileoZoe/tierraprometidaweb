...
export const Location = () => {
  ...
  // Array de íconos
  const icons = [<FaMap className="icon" />, <FaMapPin className="icon" />];
    ...
    <div className="section">
      ...
      <div className="map-container fade-in-element">
        <iframe
          ...
          title="Ubicación de Tierra Prometida" // Agregar título único aquí
          className="map fade-in-element"
        ></iframe>
      </div>

      <div>
        <p className="paragraph fade-in-element">
          Calle Guadalupe Victoria 13, Dolores, 52010 Colonia Álvaro Obregón
          Tlalmimilolpan, México.
        </p>
      </div>
      ...
      <a
        ...
        title="Contacto"
        href="https://maps.app.goo.gl/qg6mNeMVLKEW3vDY7"
      >
        {icons[iconIndex]}
        <p className="button">Cómo Llegar</p>
      </a>
    </div>
  );
};

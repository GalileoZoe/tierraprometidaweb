...
import { FaBeer, FaCandyCane, FaCannabis, FaFlask, FaSyringe } from 'react-icons/fa';
...
export const StudentsForm: React.FC<StudentsFormProps> = ({ student, onClose }) => {
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <div className='drug-select'>
                        <FaCannabis className='iconwhite' onClick={() => handleSelectDrug("Cannabis")} />
                        <FaBeer className='iconwhite' onClick={() => handleSelectDrug("Alcohol")} />
                        <FaFlask className='iconwhite' onClick={() => handleSelectDrug("Metanfetamina")} />
                        <FaSyringe className='iconwhite' onClick={() => handleSelectDrug("Heroina")} />
                    </div>
                </div>
                <div>

...
import { FaAdjust, FaApple, FaAppleAlt, FaBed, FaChess, FaChild, FaCoffee, FaComment, FaDice, FaEnvelope, FaFacebook, FaFutbol, FaHeart, FaHome, FaHotel, FaHotTub, FaLeaf, FaMask, FaMedkit, FaMusic, FaNutritionix, FaPaintBrush, FaPhone, FaRegUser, FaSpa, FaSteam, FaStethoscope, FaUser, FaUserMd, FaUsers, FaWhatsapp } from "react-icons/fa";
    ...
    switch (service) {
      ...
      case 7:
        return <Window
          ...
          description='Favorece a la salud del usuario, el proceso de desintoxicación y la creación de habitos saludables.'
          button='Más Información'
        />;
      case 8:
        return <Window
      ...
      case 9:
        return <Window
          ...
          description='Conferencias, Pintura y Música en vivo y excuriones paara favorecer y al desarrollo de una libre personalidad libre de adicciones.'
          button='Más Información'
        />;
      default:
        return null;
